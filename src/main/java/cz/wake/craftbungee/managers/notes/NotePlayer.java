package cz.wake.craftbungee.managers.notes;
...
public class NotePlayer {
    ...
    public void fetch() {
        for (Note note : Main.getNoteManager().getNotes()) {
    ...
    public void removeNote(int ID) {
        ...
        Main.getNoteManager().notes.remove(note);
        ...
        try {
            ...
            Main.getInstance().getSQLManager().getPool().close(conn, ps, null);
        }
    }
